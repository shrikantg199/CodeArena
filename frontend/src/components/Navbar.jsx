  ...
  return (
    <nav className="bg-white text-gray-800 p-4 flex items-center justify-between shadow text-[18px]">
      ...
      <div className="hidden md:flex items-center space-x-4">
        ...
        <button
          onClick={onExplore}
          className="bg-yellow-500 text-yellow-800 px-4 py-2 rounded-full"
        >
          Premium
        </button>
      </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 right-0 w-40 bg-white px-4  pb-2">
          <div className="flex flex-col space-y-2 ">
            <button
              onClick={onProblems}
              className="text-left hover:bg-gray-200 px-3 py-2 rounded"
            >
              Problems
            </button>
            <button
            ...
            <button
              onClick={onExplore}
              className=" text-left bg-yellow-500 text-yellow-800 px-3 py-1 rounded-md"
            >
              Premium
            </button>
          </div>
